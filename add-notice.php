      ...
      <div class="admin-dash">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card">
              <div class="card-body">
                <div class="card-title">Add a notice to update your team about the next important thing!</div>
                <hr>
                <form method="post" action="notice-success.php" enctype="multipart/form-data">
                  ...
                  <input type="submit" class="btn btn-dark" value="PUBLISH NOTICE">
                </form>
              </div>
            </div>
          </div>
